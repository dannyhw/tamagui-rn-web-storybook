...
var require_LayoutGroupContext = __commonJS({
  "node_modules/@tamagui/animate-presence/dist/cjs/LayoutGroupContext.js"(exports, module2) {
    ...
    var LayoutGroupContext2 = (0, import_react47.createContext)({});
  }
});
...
var require_PresenceContext = __commonJS({
  "node_modules/@tamagui/use-presence/dist/cjs/PresenceContext.js"(exports, module2) {
    ...
    var import_react47 = require("react");
    var PresenceContext2 = (0, import_react47.createContext)(null);
  }
});
...
var require_usePresence = __commonJS({
  "node_modules/@tamagui/use-presence/dist/cjs/usePresence.js"(exports, module2) {
    ...
    function usePresence2() {
      const context = (0, import_react47.useContext)(import_PresenceContext2.PresenceContext);
      if (!context) {
        return [true, null, context];
      }
      const { isPresent: isPresent22, onExitComplete, register } = context;
      const id = (0, import_react47.useId)() || "";
      (0, import_react47.useEffect)(() => register(id), [id, register]);
    ...
    function useIsPresent2() {
      return isPresent2((0, import_react47.useContext)(import_PresenceContext2.PresenceContext));
    }
...
var require_PresenceChild = __commonJS({
  "node_modules/@tamagui/animate-presence/dist/cjs/PresenceChild.js"(exports, module2) {
    ...
    var PresenceChild2 = /* @__PURE__ */ __name(({
      ...
      const presenceChildren = React39.useMemo(newChildrenMap2, []);
      const id = (0, import_react47.useId)() || "";
...
var require_AnimatePresence = __commonJS({
  "node_modules/@tamagui/animate-presence/dist/cjs/AnimatePresence.js"(exports, module2) {
    ...
    function onlyElements2(children) {
      const filtered = [];
      import_react47.Children.forEach(children, (child, index3) => {
        if ((0, import_react47.isValidElement)(child)) {
          if (!child.key && import_react47.Children.count(children) > 1) {
            if (process.env.NODE_ENV === "development") {
              console.warn("No key given to AnimatePresence child, assigning index as key");
            }
            filtered.push(
              import_react47.default.cloneElement(child, {
                key: index3
              })
            );
          } else {
    ...
    var AnimatePresence2 = /* @__PURE__ */ __name(({
      ...
      let forceRender = (0, import_web15.useForceUpdate)();
      const isClientMounted = (0, import_web15.useDidFinishSSR)();
      const forceRenderLayoutGroup = (0, import_react47.useContext)(import_LayoutGroupContext2.LayoutGroupContext).forceRender;
      ...
      const presentChildren = (0, import_react47.useRef)(childrenToRender);
      const allChildren = (0, import_react47.useRef)(/* @__PURE__ */ new Map()).current;
      const isInitialRender = (0, import_react47.useRef)(true);
      ...
      const hasWarned = process.env.NODE_ENV === "development" ? (0, import_react47.useRef)(false) : null;
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(import_jsx_runtime52.Fragment, { children: exiting.size ? childrenToRender : childrenToRender.map((child) => (0, import_react47.cloneElement)(child)) });
    }, "AnimatePresence");
...
var require_useGet = __commonJS({
  "node_modules/@tamagui/use-event/dist/cjs/useGet.js"(exports, module2) {
    ...
    var useIsomorphicLayoutEffect16 = !isWeb30 || isClient7 ? import_react47.useLayoutEffect : import_react47.useEffect;
...
var require_Collapsible = __commonJS({
  "node_modules/@tamagui/collapsible/dist/cjs/Collapsible.js"(exports, module2) {
    ...
    var import_jsx_runtime52 = require("react/jsx-runtime");
    var import_animate_presence4 = require_cjs2();
      ...
      (props, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(
          CollapsibleTriggerFrame,
          {
            ...
            ...triggerProps,
            ref: forwardedRef,
            onPress: (0, import_web15.composeEventHandlers)(props.onPress, context.onOpenToggle),
    ...
    var CollapsibleContent = CollapsibleContentFrame.styleable((props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(import_animate_presence4.AnimatePresence, { ...contentProps, children: forceMount || context.open ? /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(CollapsibleContentFrame, { ref: forwardedRef, ...contentProps, children }) : null });
    });
    ...
    var Collapsible = (0, import_web15.withStaticProperties)(_Collapsible, {
...
var require_Accordion = __commonJS({
  "node_modules/@tamagui/accordion/dist/cjs/Accordion.js"(exports, module2) {
    ...
    var AccordionImplMultiple = React39.forwardRef((props, forwardedRef) => {
      ...
      const handleItemOpen = React39.useCallback(
        (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
        [setValue]
      );
      const handleItemClose = React39.useCallback(
    ...
    var AccordionImpl = React39.forwardRef(
      (props, forwardedRef) => {
        ...
        const accordionRef = React39.useRef(null);
        const composedRef = (0, import_web15.useComposedRefs)(accordionRef, forwardedRef);
        const getItems = useCollection2(__scopeAccordion);
        const direction = (0, import_use_direction5.useDirection)(dir);
        const isDirectionLTR = direction === "ltr";
        const handleKeyDown = (0, import_web15.composeEventHandlers)(
          props.onKeyDown,
          (event) => {
            var _a;
    ...
    __name(getState6, "getState");
    var Accordion = (0, import_web15.withStaticProperties)(AccordionComponent, {
  ...
  "node_modules/@tamagui/focus-scope/dist/cjs/FocusScope.js"(exports, module2) {
    ...
    var FocusScope4 = React39.forwardRef(
      /* @__PURE__ */ __name(function FocusScope22(props, forwardedRef) {
        ...
        return React39.cloneElement(React39.Children.only(props.children), childProps);
      }, "FocusScope2")
    );
...
var require_renderProp = __commonJS({
  "node_modules/use-sidecar/dist/es5/renderProp.js"(exports) {
    ...
    function renderCar(WrappedComponent, defaults) {
      ...
      __name(State, "State");
      var Children6 = React39.memo(function(_a) {
      ...
      return /* @__PURE__ */ __name(function Combiner(props) {
        ...
        return React39.createElement(
          ...
          React39.createElement(Children6, { stateRef: ref, defaultState, children: props.children })
        );
      }, "Combiner");
    }
...
var require_Image = __commonJS({
  "node_modules/@tamagui/image/dist/cjs/Image.js"(exports, module2) {
    ...
    (0, import_core54.setupReactNative)({
      Image: import_react_native16.Image
    });
    var StyledImage = (0, import_core54.styled)(import_react_native16.Image, {
      name: "Image",
      position: "relative",
      source: { uri: "" }
    });
    ...
    Image2.getSize = import_react_native16.Image.getSize;
    Image2.getSizeWithHeaders = import_react_native16.Image.getSizeWithHeaders;
    Image2.prefetch = import_react_native16.Image.prefetch;
    Image2.prefetchWithMetadata = import_react_native16.Image.prefetchWithMetadata;
    Image2.abortPrefetch = import_react_native16.Image.abortPrefetch;
    Image2.queryCache = import_react_native16.Image.queryCache;
  }
});
...
var require_cjs20 = __commonJS({
  "node_modules/@tamagui/constants/dist/cjs/index.js"(exports, module2) {
    ...
    var isServer3 = isWeb30 && !isWindowDefined2;
    var isClient7 = isWeb30 && isWindowDefined2;
    var isRSC4 = process.env.ENABLE_RSC;
    var idFn4 = /* @__PURE__ */ __name(() => {
    }, "idFn");
    var useIsomorphicLayoutEffect16 = isRSC4 ? idFn4 : isServer3 ? import_react47.useEffect : import_react47.useLayoutEffect;
    ...
    var isTouchable4 = !isWeb30 || isWebTouchable4;
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useState26 = React39.useState, useEffect29 = React39.useEffect, useLayoutEffect6 = React39.useLayoutEffect, useDebugValue2 = React39.useDebugValue;
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useRef28 = React39.useRef, useEffect29 = React39.useEffect, useMemo19 = React39.useMemo, useDebugValue2 = React39.useDebugValue;
...
var require_dist = __commonJS({
  "node_modules/reforest/dist/index.js"(exports, module2) {
    ...
    var useIsomorphicLayoutEffect16 = isServer3 ? React210.useEffect : React210.useLayoutEffect;
        ...
        props: {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime52.jsxs)(import_jsx_runtime52.Fragment, { children: [
            themedIcon ? /* @__PURE__ */ (0, import_jsx_runtime52.jsxs)(import_jsx_runtime52.Fragment, { children: [
              themedIcon,
              /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(import_web15.Spacer, { size: spaceSize })
            ] }) : null,
            Boolean(title || subTitle) ? /* @__PURE__ */ (0, import_jsx_runtime52.jsxs)(import_stacks26.YStack, { flex: 1, children: [
              ...
              subTitle ? /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(import_jsx_runtime52.Fragment, { children: typeof subTitle === "string" && noTextWrap !== "all" ? (
                ...
                /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(Subtitle, { unstyled: mediaActiveProps.unstyled, size: size2, children: subTitle })
              ) : subTitle }) : null,
              contents
            ] }) : contents,
...
var screen = import_react_native2.Dimensions.get("screen");
var HIDDEN_SIZE = Math.max(screen.height, screen.width) + 0.1;
  ...
  if (platform2 === "ios") {
    nativeSheets[platform2] = (props) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_jsx_runtime9.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(SheetProvider, { ...providerProps, onlyShowFrame: true, children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Implementation, { ref, onModalDismiss: () => setOpen(false), children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_react_native3.View, { style: { flex: 1 }, children: props.children }) }),
...
var useKeyboardVisible = /* @__PURE__ */ __name(() => {
  ...
  (0, import_react17.useEffect)(() => {
    const keyboardDidShowListener = import_react_native4.Keyboard.addListener("keyboardDidShow", () => {
  ...
  (0, import_react19.forwardRef)(/* @__PURE__ */ __name(function SheetImplementationCustom2(props, forwardedRef) {
    ...
    const panResponder = (0, import_react19.useMemo)(
      () => {
        ...
        return import_react_native5.PanResponder.create({
    ...
    (0, import_react19.useEffect)(() => {
      if (import_core12.isWeb || !moveOnKeyboardChange)
        return;
      const keyboardDidShowListener = import_react_native5.Keyboard.addListener("keyboardDidShow", (e) => {
      ...
      const keyboardDidHideListener = import_react_native5.Keyboard.addListener("keyboardDidHide", () => {
        if (sizeBeforeKeyboard.current === null)
          return;
...
var ScrollView = (0, import_web2.styled)(import_react_native6.ScrollView, {
  name: "ScrollView",
  scrollEnabled: true,
  variants: {
    fullscreen: {
...
function createSheet({ Handle: Handle2, Frame: Frame2, Overlay: Overlay2 }) {
  ...
  const Sheet2 = (0, import_react21.forwardRef)(/* @__PURE__ */ __name(function Sheet22(props, ref) {
    ...
    if (props.native && import_react_native7.Platform.OS === "ios") {
...
function Popper(props) {
  ...
  if (import_core24.isWeb) {
    ...
    const dimensions = (0, import_react_native9.useWindowDimensions)();
    const [keyboardOpen, setKeyboardOpen] = React17.useState(false);
    React17.useEffect(() => {
      const showSubscription = import_react_native9.Keyboard.addListener("keyboardDidShow", () => {
        setKeyboardOpen(true);
      });
      const hideSubscription = import_react_native9.Keyboard.addListener("keyboardDidHide", () => {
...
var PopoverContent = PopperContentFrame.extractable(
  React19.forwardRef(
    /* @__PURE__ */ __name(function PopoverContent2(props, forwardedRef) {
      return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(PopoverContentPortal, { zIndex: props.zIndex, children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(PopoverContentInner, { ...props, ref: forwardedRef }) });
    }, "PopoverContent2")
  )
);
var PopoverContentInner = React19.memo(
  React19.forwardRef(
    (props, forwardedRef) => {
      const {
        allowPinchZoom,
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_core25.Stack, { pointerEvents: context.open ? "auto" : "none", children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_core25.Theme, { name: themeName, children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
        PopoverContentImpl,
        {
          ...contentImplProps,
          disableRemoveScroll,
...
function PopoverContentPortal(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Portal, { zIndex, children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
...
var PopoverContentPortalContents = /* @__PURE__ */ __name(({
  context,
  popperContext,
  ...props
}) => {
  const themeName = (0, import_core25.useThemeName)();
  let contents = React19.useMemo(() => props.children, [props.children]);
  if (import_react_native10.Platform.OS === "android" || import_react_native10.Platform.OS === "ios") {
    contents = /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(PopoverRepropagateContext, { popperContext, context, children: props.children });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(import_core25.Theme, { forceClassName: true, name: themeName, children: [
...
var PopoverContentImpl = React19.forwardRef((props, forwardedRef) => {
  ...
  const [hasShownOnce, setHasShownOnce] = React19.useState(false);
  const contents = React19.useMemo(() => {
  ...
  if (context.breakpointActive) {
    const childrenWithoutScrollView = React19.Children.toArray(children).map((child) => {
      if (React19.isValidElement(child)) {
        if (child.type === import_react_native10.ScrollView) {
...
var Popover = (0, import_core25.withStaticProperties)(
  ...
  }, "Popover2"),
  {
    ...
    Close: PopoverClose,
    Adapt,
    ScrollView: import_react_native10.ScrollView,
    Sheet: Sheet.Controlled
  }
);
...
var SelectContent = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(FloatingPortal, { children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
    FloatingOverlay,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_focus_scope3.FocusScope, { loop: true, trapped: !!context.open, ...focusScopeProps, children: contents })
    }
  ) });
}, "SelectContent");
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId: textId || "",
        isSelected,
        children: context.shouldRenderWebNative ? /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("option", { value, children: props.children }) : /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
...
var SelectViewport = SelectViewportFrame.styleable(
  /* @__PURE__ */ __name(function SelectViewport2(props, forwardedRef) {
    ...
    if (breakpointActive || !import_core33.isWeb) {
      return /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(PortalItem, { hostName: `${context.scopeKey}SheetContents`, children: /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(ForwardSelectContext, { context, children }) });
    }
    const {
...
function unwrapSelectItem(selectValueChildren) {
  return React26.Children.map(selectValueChildren, (child) => {
    var _a, _b, _c;
    if (child) {
...
var isServer = isWeb17 && !isWindowDefined;
var isClient4 = isWeb17 && isWindowDefined;
var isRSC2 = process.env.ENABLE_RSC;
var idFn2 = /* @__PURE__ */ __name(() => {
}, "idFn");
var useIsomorphicLayoutEffect14 = isRSC2 ? idFn2 : isServer ? import_react37.useEffect : import_react37.useLayoutEffect;
...
var SwitchComponent = SwitchFrame.extractable(
  React30.forwardRef(
    (props, forwardedRef) => {
      ...
      const shouldRenderMobileNative = !import_core38.isWeb && nativeProp === true || !import_core38.isWeb && native.includes("mobile") || native.includes("android") && import_react_native11.Platform.OS === "android" || native.includes("ios") && import_react_native11.Platform.OS === "ios";
      if (shouldRenderMobileNative) {
        return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
          import_react_native11.Switch,
          {
            value: checkedProp,
...
var TabsTrigger = TabsTriggerFrame.extractable(
  React33.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_web11.Theme, { name: isSelected ? "active" : null, children: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(
...
var Toggle = ToggleFrame.extractable(
  React34.forwardRef((props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(import_web12.Theme, { name: pressed ? "active" : null, children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
      ToggleFrame,
      {
...
var TooltipGroup = /* @__PURE__ */ __name(({ children, delay }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(FloatingDelayGroup, { delay: React36.useMemo(() => delay, [JSON.stringify(delay)]), children });
}, "TooltipGroup");
...
function useWindowDimensions2({ initial } = {}) {
  const current = (0, import_react_native12.useWindowDimensions)();
  if (process.env.TAMAGUI_TARGET != "web") {
    return current;
  }
      ...
      AnchorFrame,
      {
        ...
        ...import_core44.isWeb ? {
          ...
          onPress: (event) => {
            ...
            (_a = props.onPress) == null ? void 0 : _a.call(props, event);
            if (href !== void 0) {
              import_react_native13.Linking.openURL(href);
            }
          }
        },
        ref
...
(0, import_core49.setupReactNative)({
  TextInput: import_react_native14.TextInput
});
var defaultStyles = {
  size: "$true",
  fontFamily: "$body",
...
var Spinner = YStack.extractable(
  (0, import_core51.themeable)(
    React38.forwardRef((props, ref) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime50.jsx)(YStack, { ref, ...stackProps, children: /* @__PURE__ */ (0, import_jsx_runtime50.jsx)(import_react_native15.ActivityIndicator, { size: size2, color }) });
    }),
    {
